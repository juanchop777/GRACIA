...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO productos (nombre, descripcion, precio, categoria, stock, imagen, activo) VALUES (?, ?, ?, ?, ?, ?, 1)");
        $stmt->execute([$nombre, $descripcion, $precio, $categoria, $stock, $imagen]);
        
        header('Location: admin-productos.php?mensaje=Producto creado exitosamente');
        exit();
...
<head>
    ...
    <title>Nuevo Producto - GraciaShoes</title>
